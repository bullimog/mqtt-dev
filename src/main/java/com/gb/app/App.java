...
public class App implements MqttCallback {
    ...
    String url = protocol + broker + ":" + port;
		...
		try {
			...
			App sampleClient = new App(url, clientId, cleanSession, quietMode,userName,password);
	 ...
	 */
    public App(String brokerUrl, String clientId, boolean cleanSession, boolean quietMode, String userName, String password) throws MqttException {
